		...
		extend: {
			...
			colors: {
				...
				vintage: {
					...
					typewriter: 'hsl(var(--typewriter-green))',
					flower: 'hsl(var(--flower-orange))',
			...
			animation: {
				...
				'typewriter-bell': 'typewriter-bell 0.3s ease-in-out',
				'paper-slide': 'paper-slide 0.5s ease-out',
				'key-press': 'key-press 0.1s ease-out',
				'ink-splatter': 'ink-splatter 0.4s ease-out',
